...
- **BookUpdateResource**: информация о книге (используется при обновлении книги).
...
### 6. Дополнительное условие 3 - Тесты

Были созданы три файла с тестами AuthorTest, BookTest, ChapterTest (папка Feature)
Для запуска тестов введите команду `docker-compose run --rm artisan test`
...
#### 2. Проверка обязательных полей при создании книги
...
#### 4. Проверка получения книги с автором
...
#### 5. Проверка формата даты при создании книги
...
#### 6. Проверка получения книги с главами
...
#### 7. Проверка получения полной информации о книге
